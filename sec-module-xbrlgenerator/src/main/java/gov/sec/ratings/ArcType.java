...
@XmlType(name = "arcType", namespace = "http://www.xbrl.org/2003/XLink", propOrder = {
    "arcTitleType"
})
@XmlSeeAlso({
...
public class ArcType {
  ...
  protected List<TitleType> arcTitleType;
  ...
  /**
   * Gets the value of the arcTitleType property.
   *
   * <p>
   ...
   * the JAXB object. This is why there is not a <CODE>set</CODE> method for the arcTitleType property.
   *
   * <p>
   * For example, to add a new item, do as follows:
   * <pre>
   *    getArcTitleType().add(newItem);
   * </pre>
   *
   *
   * <p>
   ...
   */
  public List<TitleType> getArcTitleType() {
    if (arcTitleType == null) {
      arcTitleType = new ArrayList<TitleType>();
    }
    return this.arcTitleType;
  }
   ...
   *
   * @return possible object is {@link UseEnum }
   */
   ...
   *
   * @param value allowed object is {@link UseEnum }
   */
