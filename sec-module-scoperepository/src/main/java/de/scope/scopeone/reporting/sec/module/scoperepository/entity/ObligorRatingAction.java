...
/**
 * <h1>ORD - Obligor Rating Details</h1>
 * The container element used to record rating information about an obligor. One obligor can have multiple ratings over time or different types of ratings.
 */
@Getter
@Setter
@NoArgsConstructor
@AllArgsConstructor
@Entity
@Table(name = "OBLIGOR_RATING_ACTION")
public class ObligorRatingAction {

  @EmbeddedId
  private @Valid ObligorRatingActionPK id;
  ...
  /**
   * <h1>OAN - Other Announcement</h1>
   * The description of an Other Announcement type not classifiable under RAC, WST, or ROL. The NRSRO should use its own standard terminology. Example value:
   * "Company name change", "Affirm".
   * <p/>
   * At Scope: also ActionType (see History.CrdRatingAction)
   */
  ...
  public boolean equals(Object o) {
    ...
    ObligorRatingAction that = (ObligorRatingAction) o;
